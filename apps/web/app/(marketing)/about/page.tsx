...
export const metadata: Metadata = {
  title: "About — calSync",
  description: "Why we built calSync — the open-source home for your time.",
};
  ...
  return (
    <>
      <MarketingHeader
        ...
        subtitle="calSync is the open-source home for your calendar — built for people who guard their hours."
      />
      <Prose>
        <p>
