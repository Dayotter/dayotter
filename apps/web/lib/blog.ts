...
export const POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      "Your calendar is a map of your life. Here's why the software that reads it should be open — and what that means for calSync.",
    date: "2026-07-08",
    author: "The calSync team",
    readMinutes: 4,
    body: [
      {
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Open source means you can audit exactly how your data is handled — how tokens are stored, what leaves your server, and what doesn't. With calSync, OAuth tokens are encrypted at rest and we never sell your data. But you don't have to take our word for it; the code is right there.",
      ...
      },
      {
        ...
        paragraphs: [
          "Free-and-open doesn't have to mean unsustainable. calSync is open-core: the whole scheduling engine — including the advanced features — is free when you self-host. Our hosted cloud funds the work with a simple $9/seat Pro plan and a couple of managed-only extras.",
  ...
  },
  {
    ...
    excerpt:
      "Calendar AI has a trust problem: it moves your meetings without asking. calSync takes a different stance — confirm-first, always.",
    date: "2026-07-06",
    author: "The calSync team",
    readMinutes: 3,
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "calSync's AI is confirm-first. Ask it to move your 3pm to tomorrow, or to defend two hours of deep work, and it drafts an editable proposal. Nothing touches your calendar until you say so.",
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "Adaptive availability sets a ceiling on meetings per day. Once a day hits your cap — counting both calSync bookings and events on your connected calendars — calSync simply stops offering slots that day. No awkward decline emails, no manual blocking.",
          "Pair it with travel-time buffers and automated focus blocks, and your calendar starts defending itself. You set the rules once; calSync enforces them every time someone tries to book.",
        ],
      },
    ],
  },
