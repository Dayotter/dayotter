...
```
DAYOTTER_CLOUD=1                       # turn on the hosted edition
STRIPE_PRICE_PRO=price_...            # the $9/seat recurring price
DAYOTTER_MANAGED_ANTHROPIC_KEY=...     # Managed AI (cloud-only)
DAYOTTER_MANAGED_TWILIO_SID=...        # Hosted messaging (cloud-only)
DAYOTTER_MANAGED_TWILIO_TOKEN=...
DAYOTTER_MANAGED_TWILIO_SMS_FROM=...
DAYOTTER_MANAGED_TWILIO_WA_FROM=...
```
